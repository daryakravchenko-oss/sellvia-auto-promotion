...
- Final CTA: заголовок «Start selling on full autopilot», подзаголовок про hands-free promotion;
  плоский тёмный фон `#0b0b0d`, верхнее свечение убрано; по нижнему краю — градиентные столбики
  («эквалайзер»: голубой снизу → растворяются в фон), идут строго ниже текстов.
